...
import bookListData from '../../../data/resources/testData/book-list-data';
import apiPaths from '../../utils/apiPaths'

class SearchPage {
    readonly page: Page
    readonly bookAdminLabel: Locator
    readonly bookCollectionRequestRegExp: RegExp
    ...
    constructor(page: Page) {
        ...
        this.bookCollectionRequestRegExp = new RegExp(apiPaths.account);
    ...
    async mockBooksListResponse(context: BrowserContext) {
        await context.route(this.bookCollectionRequestRegExp, (route) => route.fulfill({
